...
public sealed record OpenCodeConfiguration(
    ...
    [property: JsonPropertyName("agents")] IReadOnlyDictionary<string, ConfigAgentInfo>? Agents = null,
    [property: JsonPropertyName("watcher")] ConfigWatcherInfo? Watcher = null,
    [property: JsonPropertyName("compaction")] ConfigCompactionInfo? Compaction = null,
    [property: JsonPropertyName("experimental")] ConfigExperimentalInfo? Experimental = null,
    [property: JsonPropertyName("tool_output")] ConfigToolOutputInfo? ToolOutput = null,
